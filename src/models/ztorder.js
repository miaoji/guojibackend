...
import { create, remove, update, markBlack } from '../services/ztorder'
import * as ztordersService from '../services/ztorders'
import { pageModel } from './common'
import { config } from '../utils'

const { query } = ztordersService
const { prefix } = config
