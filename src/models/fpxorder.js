...
import { create, remove, update, markBlack } from '../services/fpxorder'
import * as fpxordersService from '../services/fpxorders'
import { pageModel } from './common'
import { config } from '../utils'

const { query } = fpxordersService
const { prefix } = config
