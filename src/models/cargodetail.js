...
import { query, merge, cancel, freight } from '../services/cargodetails'
    ...
    *query ({ payload = {} }, { call, put }) {
      ...
      if (data.code===200 && data.success && data.obj) {
        for (let i=0; i < data.obj.length; i++) {
          if (data.obj[i].orderInfoSubset.length) {
              data.obj[i].children = data.obj[i].orderInfoSubset
              delete data.obj[i].orderInfoSubset
          }
        }
        yield put({
          type: 'querySuccess',
